# Example: reduce and extract spatially resolved primary and companion spectra.
...
def main():
    ...
    for night in night_list:
        ...
        # [optional] download data using astroquery package (skip if downloading data manually) 
        ppl.download_rawdata_eso(login='username', prog_id='110.23RW.006', object='YSES1 bc')
        ...
        # [optional] extract companion spectrum by giving either the location on the slit 
        # or the angular separation from the primary. The values don't have to be very accurate.
        ppl.obs_extract(object='YSES 1bc',
                        savename='1b',
        ...
        # [optional] refine wavelength solution with telluric transmission model
        ppl.refine_wlen_solution()

        # save extracted data
        ppl.save_data()

        # [optional] use the standard spectrum for spectrophotometry calibration 
        ppl.spec_response_cal(object='zet CMa', temp=15000, vsini=40, vsys=13.7)
        ppl.apply_correction()

        # [optional] use molecfit to correct for telluric absoprtion
